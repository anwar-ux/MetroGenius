...
class StarRatingWidgetState extends State<StarRatingWidget> with SingleTickerProviderStateMixin {
  double _rating = 0;
    ...
    return GestureDetector(
      onTapUp: (details) {
        ...
        if (newRating != _rating) {
          ...
          context.read<RatingAndReviewBloc>().add(RatingChanged(rating: selectedRating.toDouble()));
            ...
            children: List.generate(5, (index) {
              ...
              return Padding(
                ...
                child: ScaleTransition(
                  scale: isRated ? _scaleAnimation : const AlwaysStoppedAnimation(1.0),
                  child: Opacity(
                    ...
                    child: Transform.rotate(
                      ...
                      child: Icon(
                        ...
                        size: 35, // Fixed size, animation handled by ScaleTransition
                      ),
                    ),
                  ),
                ),
